    ...
    if ( ImGui::BeginPopup( "Node Popup" ) )
    {
      ...
      if ( ImGui::BeginPopupModal( "Node Popup Dublicate", NULL, ImGuiWindowFlags_MenuBar ) )
      {
        ...
        if ( ImGui::Button( "Apply" ) )
        {
          ...
          {
            new_node = crude_node_manager_create_node( node_tree->node_manager, crude_string_view_make( CRUDE_ENTITY_GET_IMMUTABLE_COMPONENT( world, node_tree->node_reference, crude_node_external )->node_relative_filepath ),world );
      ...
      if ( ImGui::BeginPopupModal( "Node Popup Create Child", NULL, ImGuiWindowFlags_MenuBar ) )
      {
        ...
        if ( ImGui::Button( "Apply" ) )
        {
          ...
          case CRUDE_GUI_NODE_TYPE_LIGHT:
          {
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_light, { crude_light_empty( ) } );
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_transform, { crude_transform_empty( ) } );
            break;
          }
          ...
          case CRUDE_GUI_NODE_TYPE_PHYSICS_BODY:
          {
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_physics_body, { crude_physics_body_empty( ) } );
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_transform, { crude_transform_empty( ) } );
            break;
          }
          ...
          case CRUDE_GUI_NODE_TYPE_DDGI_AREA:
          {
          ...
          {
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_world_environment, { crude_world_environment_empty( ) } );
            break;
          }
          ...
          case CRUDE_GUI_NODE_TYPE_ANIMATION_PLAYER:
          {
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_animation_player, { crude_animation_player_empty( ) } );
            CRUDE_ENTITY_SET_COMPONENT( world, new_node, crude_transform, { crude_transform_empty( ) } );
            break;
          }
          }
