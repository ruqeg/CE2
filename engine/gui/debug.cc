...
)
{
...

  {
    ...
    ray_tracing_solid_pass_node = crude_gfx_render_graph_builder_access_node_by_name( &debug->engine->render_graph_builder, CRUDE_STRING_VIEW_MAKE( "ray_tracing_solid_pass" ) );
