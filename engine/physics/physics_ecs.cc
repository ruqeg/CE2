...
CRUDE_PARSE_JSON_TO_COMPONENT_FUNC_IMPLEMENTATION( crude_physics_body )
{
  ...
  case CRUDE_PHYSICS_SHAPE_TYPE_MESH:
  {
    ...
    crude_string_view                                      mesh_relative;
    ...
    mesh_relative = crude_string_view_make( cJSON_GetStringValue( mesh_json_relative_filepath ) );
    
    if ( crude_string_view_valid( mesh_relative ) && mesh_relative.data[ 0 ] )
    {
