...
typedef struct crude_gfx_scene_renderer_options
{
  struct 
  {
    crude_string_view                                      depth;
  } depth_pyramid_pass;
  struct 
  {
    crude_string_view                                      hdr_pre_tonemapping;
    float32                                                gamma;
  } postprocessing_pass;
  struct
  {
    crude_string_view                                      depth_texture;
    crude_string_view                                      direct_radiance_texture;
    crude_string_view                                      normal_texture;
    crude_string_view                                      roughness_metalness_texture;
    crude_string_view                                      ssr_hit_uv_depth_rdotv_texture;
    crude_string_view                                      ssr_texture;
  } ssr_pass;
  struct
  {
    crude_string_view                                      direct_radiance_texture;
    crude_string_view                                      indirect_radiance_texture;
    crude_string_view                                      radiance_texture;
    crude_string_view                                      albedo_texture;
    crude_string_view                                      roughness_metalness_texture;
    crude_string_view                                      ssr_texture;
  } compose_pass;
  ...
  {
    uint32                                                 debug_mode;
    bool                                                   show_debug_collision;
    bool                                                   show_debug_gltf;
    uint32                                                 flags1;
...
typedef struct crude_gfx_scene_renderer
{
...
#if CRUDE_DEVELOP
  crude_gfx_model_renderer_resources_instance             *debug_model_renderer_resoruces_instances;
  crude_gfx_debug_line_vertex                             *debug_line_vertices_3d;
  ...
  crude_gfx_depth_pyramid_pass                             depth_pyramid_farthest_pass;
  crude_gfx_depth_pyramid_pass                             depth_pyramid_nearest_pass;
