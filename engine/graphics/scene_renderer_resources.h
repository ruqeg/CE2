...
#define CRUDE_LIGHT_TETRAHEDRON_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_light_tetrahedron.gltf"
#define CRUDE_CAMERA_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_camera.gltf"
#define CRUDE_CAPSULE_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_capsule.gltf"
#define CRUDE_PHYSICS_BOX_COLLISION_SHAPE_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_physics_box_collision_shape.gltf"
#define CRUDE_AUDIO_PLAYER_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_audio_player.gltf"
#define CRUDE_AUDIO_LISTENER_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_audio_listener.gltf"
#define CRUDE_RAY_DEBUG_MODEL_REALTIVE_FILEPATH "editor\\models\\crude_ray.gltf"
