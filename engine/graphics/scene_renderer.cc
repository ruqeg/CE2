...
)
{
  ...
  scene_renderer->options.ssr_pass.normal_texture = "direct_normal";
  scene_renderer->options.ssr_pass.roughness_metalness_texture = "direct_roughness_metalness";
  ...
  scene_renderer->options.compose_pass.roughness_metalness_texture = "direct_roughness_metalness";
...
)
{
  ...
  crude_gfx_render_graph_builder_register_render_pass( render_graph->builder, CRUDE_STRING_NODE( "depth_pyramid_farthest_pass" ), crude_gfx_depth_pyramid_pass_pack( &scene_renderer->depth_pyramid_farthest_pass ) );
  crude_gfx_render_graph_builder_register_render_pass( render_graph->builder, CRUDE_STRING_NODE( "depth_pyramid_nearest_pass" ), crude_gfx_depth_pyramid_pass_pack( &scene_renderer->depth_pyramid_nearest_pass ) );
