...
#define CRUDE_GFX_CMD_PUSH_MARKER( cmd, name )\
  crude_gfx_cmd_push_marker( cmd, CRUDE_STRING_VIEW_MAKE( "" name ) );

#define CRUDE_GFX_CMD_POP_MARKER( cmd )\
  crude_gfx_cmd_pop_marker( cmd );