...
#define CRUDE_GFX_MESHLET_MAX_TRIANGLES                    ( 126 )
...
CRUDE_SHADER_STRUCT( crude_gfx_mesh_draw_count )
{
  ...
  uint32                                                   depth_pyramid_farthest_texture_index;
...
CRUDE_SHADER_RBUFFER_REF( MeshDrawRef, crude_gfx_mesh_draw );
