...
typedef enum crude_gfx_depth_pyramid_type
{
  CRUDE_GFX_DEPTH_PYRAMID_TYPE_FARTHEST,
  CRUDE_GFX_DEPTH_PYRAMID_TYPE_NEAREST,
} crude_gfx_depth_pyramid_type;
...
typedef struct crude_gfx_depth_pyramid_pass
{
  ...
  crude_gfx_depth_pyramid_type                             type;
