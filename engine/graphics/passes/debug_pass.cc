...
)
{
  ...
  
  {
    ...
    pipeline = CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( "debug_line3d" );
  ...
  
  {
    ...
    pipeline = CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( "debug_line2d" );
...

  {
    ...
    pipeline = CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( "debug_cube" );
