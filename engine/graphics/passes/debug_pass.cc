...
)
{
  ...
  
  {
    ...
    pipeline = crude_gfx_access_technique_pass_by_name( gpu, "debug", "debug_line3d" )->pipeline;
  ...
  
  {
    ...
    pipeline = crude_gfx_access_technique_pass_by_name( gpu, "debug", "debug_line2d" )->pipeline;
...

  {
    ...
    pipeline = crude_gfx_access_technique_pass_by_name( gpu, "debug", "debug_cube" )->pipeline;
