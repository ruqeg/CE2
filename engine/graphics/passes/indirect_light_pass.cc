...
)
{
  ...
  /* Probe Raytracer */
  {
    ...
    pipeline = crude_gfx_access_technique_pipeline_by_name( pass->scene_renderer->gpu, "probe_raytracer", 0u );
  ...
  if ( pass->offsets_calculations_count >= 0 )
  {
    ...
    pipeline = crude_gfx_access_technique_pipeline_by_name( gpu, "calculate_probe_offsets", 0u );
  ...
  /* Probe Update Irradiance */
  {
    ...
    pipeline = crude_gfx_access_technique_pipeline_by_name( gpu, "probe_update_irradiance", 0u );
  ...
  /* Probe Update Visibility */
  {
    ...
    pipeline = crude_gfx_access_technique_pipeline_by_name( gpu, "probe_update_visibility", 0u );
  ...
  /* Sample Irradiance */
  {
    ...
    pipeline = crude_gfx_access_technique_pipeline_by_name( gpu, "sample_irradiance", 0u );
