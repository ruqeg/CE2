...
)
{
  ...
  CRUDE_STRING_RAW_COPY( texture_creation.name, "culled_tetrahedron_shadow_texture" );
  ...
  CRUDE_STRING_RAW_COPY( framebuffer_creation.name, "culled_tetrahedron_framebuffer" );
  ...
  sampler_creation.name = CRUDE_STRING_VIEW_MAKE( "culled_tetrahedron_shadow_sampler" );
...
)
{
  ...
  pointshadow_culling_pipeline = CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( "pointshadow_culling" );
  pointshadow_commands_generation_pipeline = CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( "pointshadow_commands_generation" );
  pointshadow_pipeline = CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( "pointshadow" );
