...
)
{
  ...
  crude_gfx_cmd_push_marker( primary_cmd, "luminance_histogram_generation_pass" );
  {
    ...
    luminance_histogram_generation_pipeline = crude_gfx_access_technique_pipeline_by_name( pass->scene_renderer->gpu, "luminance_histogram_generation", 0u );
  ...
  crude_gfx_cmd_push_marker( primary_cmd, "luminance_average_calculation_pass" );
  {
    ...
    luminance_average_calculation_pipeline = crude_gfx_access_technique_pipeline_by_name( pass->scene_renderer->gpu, "luminance_average_calculation", 0u );
...
)
{
  ...
  postprocessing_pipeline = crude_gfx_access_technique_pipeline_by_name( pass->scene_renderer->gpu, "postprocessing", 0u );
