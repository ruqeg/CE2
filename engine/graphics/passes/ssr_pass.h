...
typedef struct crude_gfx_ssr_pass
{
  ...
  crude_gfx_texture_handle                                 radiance_hierarchy_temporary_texture_handle;
  crude_gfx_texture_handle                                 radiance_hierarchy_temporary_views_handles[ CRUDE_GRAPHICS_SSR_RADIANCE_TEXTURES_MAX_LEVELS ];
