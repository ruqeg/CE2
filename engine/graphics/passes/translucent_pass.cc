...
)
{
  ...
  pipeline = gpu->mesh_shaders_extension_present 
    ? crude_gfx_access_technique_pipeline_by_name( gpu, "translucent_no_cull_meshlet", 0u )
    : crude_gfx_access_technique_pipeline_by_name( gpu, "translucent_no_cull_classic", 0u );
