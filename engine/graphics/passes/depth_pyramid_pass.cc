...
)
{
  ...
  depth_pyramid_pipeline = crude_gfx_access_technique_pipeline_by_name( pass->scene_renderer->gpu,
    ( pass->type == CRUDE_GFX_DEPTH_PYRAMID_TYPE_FARTHEST ) ? "depth_pyramid_farthest" : "depth_pyramid_nearest", 0u );
...
)
{
  ...
  crude_string_copy( depth_hierarchy_creation.name, ( pass->type == CRUDE_GFX_DEPTH_PYRAMID_TYPE_FARTHEST ) ? "depth_hierarchy_farthest" : "depth_hierarchy_nearest", sizeof( depth_hierarchy_creation.name ) );
  ...
  depth_pyramid_view_creation.name = ( pass->type == CRUDE_GFX_DEPTH_PYRAMID_TYPE_FARTHEST ) ? "depth_pyramid_view_farthest" : "depth_pyramid_view_nearest";
