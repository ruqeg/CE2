...
(
  ...
  _In_ crude_string_view const                             code,
...
)
{
  ...
  if ( strcmp( format, "FORMAT_R10G10B10A2_UNORM" ) == 0 ) return CRUDE_GFX_RHI_FORMAT_A2B10G10R10_UNORM_PACK32;
  if ( strcmp( format, "FORMAT_R10G10B10A2_SNORM" ) == 0 ) return CRUDE_GFX_RHI_FORMAT_A2B10G10R10_SNORM_PACK32;
  if ( strcmp( format, "FORMAT_R16G16_SFLOAT" ) == 0 ) return CRUDE_GFX_RHI_FORMAT_R16G16_SFLOAT;
