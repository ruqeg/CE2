...
typedef struct crude_gfx_model_renderer_resources
{
  ...
  uint32                                                   total_meshlets_count;
  uint32                                                   total_meshlets_vertices_count;
  uint32                                                   total_meshlets_vertices_indices_count;
  uint32                                                   total_meshlets_triangles_indices_count;
  
  /* Ray tracing realted geometry */
