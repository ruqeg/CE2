...
typedef struct crude_gfx_render_graph_resource_info
{
  ...
  union
  {
    struct
    {
      ...
      crude_gfx_rhi_image_usage_flags                      flags;
...
typedef void (*crude_gfx_render_graph_render_pass_on_resize)( void *ctx, uint32 new_width, uint32 new_height );
