...
typedef struct crude_gfx_device
{
  ...
  crude_gfx_rhi_resource_state                             rhi_swapchain_images_states[ CRUDE_GFX_SWAPCHAIN_IMAGES_MAX_COUNT ];
  ...
  crude_gfx_memory_allocation                              blas_identity_transform_hga;
...
#define CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME( technique_name )\
crude_gfx_access_technique_pipeline_by_name( gpu, CRUDE_STRING_VIEW_MAKE( "" technique_name ), 0 )

#define CRUDE_GFX_ACCESS_TECHNIQUE_PIPELINE_BY_NAME_WITH_FLAGS( technique_name, flags )\
crude_gfx_access_technique_pipeline_by_name( gpu, CRUDE_STRING_VIEW_MAKE( "" technique_name ), flags )