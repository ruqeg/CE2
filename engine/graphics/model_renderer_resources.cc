...
{
  model_renderer_resources->meshlets_hga = crude_gfx_memory_allocation_empty( );
  model_renderer_resources->meshlets_vertices_hga = crude_gfx_memory_allocation_empty( );
  model_renderer_resources->meshlets_vertices_joints_hga = crude_gfx_memory_allocation_empty( );
  model_renderer_resources->meshlets_vertices_positions_hga = crude_gfx_memory_allocation_empty( );
  model_renderer_resources->meshlets_vertices_indices_hga = crude_gfx_memory_allocation_empty( );
  model_renderer_resources->meshlets_triangles_indices_hga = crude_gfx_memory_allocation_empty( );
  model_renderer_resources->meshes_draws_hga = NULL;
}
...
{
  crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshlets_hga );
  crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshlets_vertices_hga );
  crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshlets_vertices_joints_hga );
  crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshlets_vertices_positions_hga );
  crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshlets_vertices_indices_hga );
  crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshlets_triangles_indices_hga );

  if ( model_renderer_resources->meshes_draws_hga )
  {
    for ( uint32 i = 0; i < CRUDE_ARRAY_LENGTH( model_renderer_resources->meshes_draws_hga ); ++i )
    {
      crude_gfx_memory_deallocate( gpu, model_renderer_resources->meshes_draws_hga[ i ] );
    }
  }
...
)
{
  *instance = CRUDE_COMPOUNT_EMPTY( crude_gfx_model_renderer_resources_instance );
  ...
  if ( manager )
  {
    ...
    model_renderer_resources = crude_gfx_model_renderer_resources_manager_access( manager, handle );
...
)
{
  ...
  model_renderer_resources = crude_gfx_model_renderer_resources_manager_access( manager, model_renderer_resources_instance->model_renderer_resources_handle );
...
{
  crude_gfx_model_renderer_resources *model_renderer_resources = crude_gfx_model_renderer_resources_manager_access( manager, instance->model_renderer_resources_handle );
...
)
{
  ...
  {
    if ( crude_string_raw_cmp( model_renderer_resources->nodes[ i ].name, name.data ) == 0 )
    {
      return i;
    }
  }
