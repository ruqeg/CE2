...
)
{
  ...
  crude_gui_lightmaps_initialize( &editor->lightmaps, &editor->engine->common_allocator );
}
...
)
{
  ...
  if ( crude_entity_valid( editor->engine->world, editor->selected_node ) )
  {
    ...
    crude_string_copy( editor->editor_selected_entity_name, entity_path, sizeof( editor->editor_selected_entity_name ) );
