...
CRUDE_PARSE_JSON_TO_COMPONENT_FUNC_IMPLEMENTATION( crude_world_environment )
{
  ...
  component->ambient_color.x = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ambient_color_x" ) );
  component->ambient_color.y = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ambient_color_y" ) );
  component->ambient_color.z = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ambient_color_z" ) );
...
CRUDE_PARSE_COMPONENT_TO_JSON_FUNC_IMPLEMENTATION( crude_world_environment )
{
  ...
  cJSON_AddItemToObject( world_environment_json, "ambient_color_x", cJSON_CreateNumber( component->ambient_color.x ) );
  cJSON_AddItemToObject( world_environment_json, "ambient_color_y", cJSON_CreateNumber( component->ambient_color.y ) );
  cJSON_AddItemToObject( world_environment_json, "ambient_color_z", cJSON_CreateNumber( component->ambient_color.z ) );
