  ...
  if ( ImGui::BeginDragDropTarget( ) )
  {
    ...
    if ( im_payload )
    {
      ...
      if ( strstr( replace_relative_filepath, ".crude_node" ) )
      {
        ...
        crude_string_copy( node_external.node_relative_filepath, replace_relative_filepath, sizeof( node_external.node_relative_filepath ) );
        
        parent = crude_entity_get_parent( world, node );

        crude_string_copy( new_name, crude_entity_get_name( world, node ), sizeof( new_name ) );
...
CRUDE_PARSE_JSON_TO_COMPONENT_FUNC_IMPLEMENTATION( crude_world_environment )
{
  ...
  component->ssr.type = CRUDE_CAST( crude_world_environment_ssr_type, cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ssr.type" ) ) );
  component->ssr.max_steps = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ssr.max_steps" ) );
  component->ssr.max_distance = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ssr.max_distance" ) );
  ...
  component->ssr.stride_zcutoff = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ssr.stride_zcutoff" ) );
  component->ssr.stride = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ssr.stride" ) );
  component->ssr.z_thickness = cJSON_GetNumberValue( cJSON_GetObjectItemCaseSensitive( component_json, "ssr.z_thickness" ) );
...
CRUDE_PARSE_COMPONENT_TO_JSON_FUNC_IMPLEMENTATION( crude_world_environment )
{
  ...
  cJSON_AddItemToObject( world_environment_json, "ssr.max_distance", cJSON_CreateNumber( component->ssr.max_distance ) );
  ...
  cJSON_AddItemToObject( world_environment_json, "ssr.stride_zcutoff", cJSON_CreateNumber( component->ssr.stride_zcutoff ) );
  cJSON_AddItemToObject( world_environment_json, "ssr.stride", cJSON_CreateNumber( component->ssr.stride ) );
  cJSON_AddItemToObject( world_environment_json, "ssr.z_thickness", cJSON_CreateNumber( component->ssr.z_thickness ) );
...
CRUDE_PARSE_COMPONENT_TO_IMGUI_FUNC_IMPLEMENTATION( crude_world_environment )
{
  ...
  CRUDE_IMGUI_OPTION( "SSR Max Distance", {
    ImGui::DragFloat( "##SSR Max Distance", &component->ssr.max_distance, 1.f, 0.f );
  } );
  ...
  CRUDE_IMGUI_OPTION( "SSR Stride zcutoff", {
    ImGui::DragFloat( "##SSR Stride zcutoff", &component->ssr.stride_zcutoff, 1.f, 0.f );
  } );
  
  CRUDE_IMGUI_OPTION( "SSR Stride", {
    ImGui::DragFloat( "##SSR Stride", &component->ssr.stride, 1.f, 0.f );
  } );
  
  CRUDE_IMGUI_OPTION( "SSR Zthickness", {
    ImGui::DragFloat( "##SSR Zthickness", &component->ssr.z_thickness, 1.f, 0.f );
  } );
