...
(
  _In_ crude_components_serialization_manager             *manager,
  _In_ crude_string_view const                             component_name,
...
crude_components_serialization_manager_add_json_to_component( manager, crude_string_view_make( #component_type ), crude_components_serialization_parse_json_to_component__func_raw##component_type )
...
{\
  ...
  if ( component && ImGui::CollapsingHeader( CRUDE_COMPONENT_STRING( component_type ), ImGuiTreeNodeFlags_DefaultOpen ) )\
  {\
