...
)
{
  ...
  float2->x = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 0 ) ) );
  float2->y = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 1 ) ) );
}
...
)
{
  ...
  float3->x = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 0 ) ) );
  float3->y = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 1 ) ) );
  float3->z = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 2 ) ) );
}
...
)
{
  ...
  float4->x = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 0 ) ) );
  float4->y = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 1 ) ) );
  float4->z = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 2 ) ) );
  float4->w = CRUDE_CAST( float32, cJSON_GetNumberValue( cJSON_GetArrayItem( json, 3 ) ) );
}
