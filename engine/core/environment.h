...
typedef struct crude_environment
{
  struct
  {
    ...
    uint32                                                 render_graph_absolute_directory_length;
    char const                                            *resources_absolute_directory;
    uint32                                                 resources_absolute_directory_length;
    char const                                            *shaders_absolute_directory;
    uint32                                                 shaders_absolute_directory_length;
    char const                                            *compiled_shaders_absolute_directory;
    uint32                                                 compiled_shaders_absolute_directory_length;
    char const                                            *temporary_absolute_directory;
    uint32                                                 temporary_absolute_directory_length;
  } directories;
  struct
  {
