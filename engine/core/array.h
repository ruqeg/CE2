...
#define CRUDE_ARRAY_HEADER( a )  ( CRUDE_CAST( crude_array_header*, a ) - 1 )
#define CRUDE_ARRAY_HEADER_CONST( a )  ( CRUDE_CAST( crude_array_header const*, a ) - 1 )
#define CRUDE_ARRAY_ARRAY_GROW( a, b, c, d ) ( ( a ) = CRUDE_CAST( CRUDE_TYPE( a ), crude_array_growf( ( a ), sizeof *( a ), ( b ), ( c ), ( d ) ) ) )
