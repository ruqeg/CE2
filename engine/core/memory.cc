...
)
{
  ...
  stats = CRUDE_CAST( memory_statistics*, user );
...
static void* crude_heap_allocate_raw( void *ctx, sizet size ) { return crude_heap_allocator_allocate( CRUDE_CAST( crude_heap_allocator*, ctx ), size ); }
static void crude_heap_deallocate_raw( void *ctx, void *pointer ) { crude_heap_allocator_deallocate( CRUDE_CAST( crude_heap_allocator*, ctx ), pointer ); }
static void* crude_heap_allocate_align_raw( void *ctx, sizet size, sizet alignment ) { return crude_heap_allocator_allocate_align( CRUDE_CAST( crude_heap_allocator*, ctx ), size, alignment ); }
static void* crude_stack_allocate_raw( void *ctx, sizet size ) { return crude_stack_allocator_allocate( CRUDE_CAST( crude_stack_allocator*, ctx ), size ); }
...
static void* crude_linear_allocate_raw( void *ctx, sizet size ) { return crude_linear_allocator_allocate( CRUDE_CAST( crude_linear_allocator*, ctx ), size ); }
