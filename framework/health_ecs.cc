...
#include <framework/health_ecs.h>
...
CRUDE_PARSE_COMPONENT_TO_JSON_FUNC_IMPLEMENTATION( crude_health )
{
  ...
  cJSON_AddItemToObject( component_json, "type", cJSON_CreateString( CRUDE_COMPONENT_STRING( crude_health ) ) );
  cJSON_AddItemToObject( component_json, "max_health", cJSON_CreateNumber( component->max_health ) );
